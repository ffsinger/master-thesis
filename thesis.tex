...
[Benchmarks of the different versions (plaintext, palisade, seal, pytorch; pixelwise and channelwise) with the different metrics (accuracy, runtime, memory, serialization)]
