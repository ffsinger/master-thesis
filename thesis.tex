...
\begin{itemize}
  ...
  \item Approximate sigmoid activation $f(x) = 0.5 - 1.20096 \cdot (x/8) + 0.81562 \cdot (x/8)^3$ \cite{kim_logistic_2018}
  \item Approximate $\tanh$ activation $f(x) = -0.00163574303018748 \cdot x^3 + 0.249476365628036 \cdot x$ \cite{podschwadt_classification_2020}
