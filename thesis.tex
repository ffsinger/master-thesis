...
We observe that the encrypted pipelines are orders of magnitude slower than the baselines.
PALISADE is faster than SEAL by a factor $3$ for training and a factor $10$ for the initialization. 
