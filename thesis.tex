...
The network architecture used in this evaluation is not designed for maximal accuracy, rather it shows the differences between different layer types.
...
The network architecture is LeNet-5 by LeCun \cite{lecun_gradient-based_1998} (\autoref{table:lenet})
...
[Other works on NN: shallow networks optimized for a single architecture,  GPUs, ... Mine is meant to be flexible.]
