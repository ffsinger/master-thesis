...
We attempt to solve the problems of secure model training and inference using this technique, and analyze the results with the goal of a real-world deployement.
...
[Make the first convolutions on the client, non-encrypted. Some part of the model is revealed to the client which can make it a bit easier to steal, but the data is still secure.]
