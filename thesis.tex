...
The first schemes supported only one type of operation, such as homomorphic additions with the Paillier \cite{paillier_public-key_1999} cryptosystem (1999).
...
This family is contains multiple subcategories, but the general goal is to extract some knowledge from the training dataset. 
